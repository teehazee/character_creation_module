...
def attack(char_name: str, char_class: str):
    """Сalculate the amount of damage from the character class."""
...
def defence(char_name: str, char_class: str):
    """Сalculate the amount of blocked damage from the character class."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str):
    """Display special spell and it's amount."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str):
    """Display selected class and it's description."""
    if char_class == 'warrior':
...
def choice_char_class():
    """Display other characters default information."""
    approve_choice: str = ''
    char_class: str = ''
